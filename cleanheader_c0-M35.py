...
def main():
    ...
    prefix='hlsp_k2superstamp_k2_photometer_c0-m35'
    suffix='_kepler_v1_image'
    oldprefix='M35'

    filenames = np.loadtxt('filenames_M35_wcsfinal.txt',dtype='str')

    tpfs = glob.glob('/Volumes/Work/Field_0/M35/TPFs/ktwo200*targ.fits')
