...
def main():
    ...
    filenames = np.loadtxt('filenames_M8_wcsfinal.txt',dtype='str')

    tpfs1 = glob.glob('/Volumes/Work/Field_9/TPFs_part1_superstamp/ktwo200*targ.fits')
    tpfs2 = glob.glob('/Volumes/Work/Field_9/TPFs_part2_superstamp/ktwo200*targ.fits')
    tpfs  = tpfs1 + tpfs2

    for oldoutfile in filenames:

     time = oldoutfile[6:18]
